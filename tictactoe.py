...
def check_win():
    ...
    for i in range(3):
        if field[i][0] != "~" and field[i][0] == field[i][1] and field[i][0] == field[i][2] :
            result = messagebox.askyesno(title = "Game Over", message = f"{field[i][0]} win the game!\nDo you wanna play again?")
            win_the_game = True
            if result == True :
                start_new_game()
            else :
        ...
        if field[0][i] != "~" and field[0][i] == field[1][i] and field[0][i] == field[2][i] :
            result = messagebox.askyesno(title = "Game Over", message = f"{field[0][i]} win the game!\nDo you wanna play again?")
            win_the_game = True
            if result == True :
                start_new_game()
            else :
    ...
    if field[0][0] != "~" and field[0][0] == field[1][1] and field[0][0] == field[2][2] :
        result = messagebox.askyesno(title = "Game Over", message = f"{field[0][0]} win the game!\nDo you wanna play again?")
        win_the_game = True
        if result == True :
            start_new_game()
        else :
    ...
    if field[0][2] != "~" and field[0][2] == field[1][1] and field[0][2] == field[2][0] :
        result = messagebox.askyesno(title = "Game Over", message = f"{field[0][2]} win the game!\nDo you wanna play again?")
        win_the_game = True
        if result == True :
            start_new_game()
        else :
    ...
    for i in range(3):
        for j in range(3):
            if field[i][j] == "~" :
                ...
                break
    if nobody_win == True :
        result = messagebox.askyesno(title = "Game Over", message = f"Friendship forever!\nDo you wanna play again?")
        win_the_game = True
        if result == True :
            start_new_game()
        else :
